package com.ruchir55.flagquiz.database;
...
public class DatabaseCopyHelper extends SQLiteOpenHelper  {
	...
	private static String DB_NAME = "countries1.db";
	...
	public void createDatabase() throws IOException {
		...
		if(dbExist) {
			...
			//Toast.makeText(myContext.getApplicationContext(),"Database already exists", Toast.LENGTH_SHORT).show();
		} else {
