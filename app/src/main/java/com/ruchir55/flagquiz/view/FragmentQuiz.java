...
import com.ruchir55.flagquiz.database.FlagsDao;
import com.ruchir55.flagquiz.databinding.FragmentQuizBinding;
import com.ruchir55.flagquiz.model.FlagsModel;
...
public class FragmentQuiz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(FlagsModel flag : flagList) {
            ...
            Log.d("flags", String.valueOf(flag.getCountryName()));
            Log.d("flags", String.valueOf(flag.getFlagName()));
            Log.d("flags", "***************************");
        }
        ...
        fragmentQuizBinding.buttonNext.setOnClickListener(v -> {
            ...
            if(!optionControl && questionNumber < 10) {
                emptyNumber++;
            ...
            else if (optionControl && questionNumber < 10){
    ...
    public void showData() {
        ...
        fragmentQuizBinding.textViewQuestion.setText(getResources().getString(R.string.question_number).concat(" ").concat(String.valueOf(questionNumber + 1)));
